...
var date_settings = function(settings) {
	...
	if(settings.DateBlurColor){
		date.getStyle().textShadow = date.setVar('blur_color','0 0 10px rgb('+settings.DateBlurColor.value.split(' ').map(function(c){return Math.ceil(c*255)})+')')
	}
